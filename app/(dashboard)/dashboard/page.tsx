...
export default async function DashboardPage() {
  ...
  const visiblePayouts =
    user.role === "doctor"
      ...
      : data.payouts.filter((payout) => payout.payoutMode !== "pending_shift");
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <MetricCard
          ...
          helper="Invoice payouts and shift vouchers"
          icon={Stethoscope}
          tone="care"
        />
        <MetricCard
        ...
        <section className="panel p-5">
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">Doctor earnings generated by payment model.</p>
            </div>
